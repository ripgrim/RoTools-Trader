    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-background p-4 mb-4 rounded-none">
        ...
        <div>
          ...
          {image ? (
            ...
            <div className="flex items-center justify-center h-[300px] border border-dashed border-border rounded-none p-8 bg-background/50">
