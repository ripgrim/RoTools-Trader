  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="mb-8">
        ...
        <div className="overflow-auto border border-border rounded-lg mb-4" style={{ maxHeight: '500px', background: '#09090B' }}>
          <div 
            ref={rawPreviewRef} 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {imageUrl ? (
            ...
            <div className="flex items-center justify-center h-64 border border-dashed border-border rounded-lg p-8 bg-background">
